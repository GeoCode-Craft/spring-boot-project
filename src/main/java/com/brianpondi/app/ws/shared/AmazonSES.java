package com.brianpondi.app.ws.shared;
...
public class AmazonSES {
    ...
    final String FROM = "pondibrian@gmail.com";
    ...
    final String TEXTBODY = "Please verify your email address. "
            ...
            + " http://ec2-3-137-142-80.us-east-2.compute.amazonaws.com/verification-service/email-verification.html?token=$tokenValue"
            + " Thank you! And we are waiting for you inside!";
    ...
    final String PASSWORD_RESET_HTMLBODY = "<h1>A request to reset your password</h1>"
            ...
            + "<a href='http://ec2-3-137-142-80.us-east-2.compute.amazonaws.com/verification-service/password-reset.html?token=$tokenValue'>"
    ...
    final String PASSWORD_RESET_TEXTBODY = "A request to reset your password "
            ...
            + " http://ec2-3-137-142-80.us-east-2.compute.amazonaws.com/verification-service/password-reset.html?token=$tokenValue"
            + " Thank you!";
